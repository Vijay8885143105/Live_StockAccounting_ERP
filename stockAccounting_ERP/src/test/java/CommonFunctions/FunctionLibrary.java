...
public class FunctionLibrary {
	...
	public static void openApplcation(WebDriver driver) throws Throwable
	{
	...
	public static void captureCusto(WebDriver driver,String Locator_Type,String Locator_Value)throws Throwable
	{
		...
		FileWriter fw = new FileWriter("./CaptureData/custonum.txt");
		BufferedWriter bw = new BufferedWriter(fw);
		bw.write(Expected_Data);
		bw.flush();
		bw.close();
	...
	public static void custoTable(WebDriver driver)throws Throwable
	{
		...
		driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("search-panel"))).click();
		//enter category name
		driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("search-textbox"))).sendKeys( Exp_customernumber);
		driver.findElement(By.xpath(PropertyFileUtil.getValueForKey("search-button"))).click();
		Thread.sleep(3000);
		String Act_customernumber = driver.findElement(By.xpath("//input[@id='x_Customer_Number']")).getText();
